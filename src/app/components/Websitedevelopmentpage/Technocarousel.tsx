...
function Technocarousel() {
    ...
    return (
        <div className="px-6 sm:px-12 lg:px-28 mt-20">
            ...
            <div className="flex flex-col gap-5 mt-14 mb-14">
                ...
                <div>
                    <h2 className="text-xl text-center font-semibold">Softworks Technologies</h2>
                </div>

                <div className='text-center'>
                    <h2 className='text-3xl font-bold'>Collaborate with Our Software Company</h2>
                </div>
