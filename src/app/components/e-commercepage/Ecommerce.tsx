...
import { headingVariant, fadeDown } from '../../../../animations/animations'
    ...
    return (
        <div className="px-4 sm:px-6 md:px-12 lg:px-20 xl:px-28 mt-8">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:items-center">
                ...
                {/* Text content */}
                <AnimateOnView variants={fadeDown} className="flex flex-col gap-4 text-gray-700 justify-center order-2 lg:order-1 px-2 sm:px-4 h-full">
                    <AnimateOnView variants={headingVariant} className="text-center lg:text-left">
                ...
                {/* Image */}
                <AnimateOnView variants={fadeDown} className="flex justify-center order-1 lg:order-2 h-full">
                    <img
