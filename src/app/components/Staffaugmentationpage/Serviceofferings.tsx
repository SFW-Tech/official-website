...
function Serviceofferings() {
  return (
    <div className="px-6 xl:px-28 bg-blue-50 py-10">
      <div className="flex flex-col gap-10 xl:gap-14 text-center">
        ...
        {/* Cards Section */}
        <div className="grid grid-cols-1 xl:grid-cols-3 gap-6 xl:gap-30">
          {/* Card 1 */}
          <div className="flex flex-col gap-4 border p-6 xl:p-8 border-gray-300">
            <div className="flex justify-center">
              <div className="flex items-center justify-center w-16 h-16 xl:w-22 xl:h-22 rounded-full bg-[#001A5A]">
                ...
                >
                  <path
                    fillRule="evenodd"
                    d="M8.25 6.75a3.75 3.75 0 1 1 7.5 0 3.75 3.75 0 0 1-7.5 0ZM15.75 9.75a3 3 0 1 1 6 0 3 3 0 0 1-6 0ZM2.25 9.75a3 3 0 1 1 6 0 3 3 0 1 1 -6 0ZM6.31 15.117A6.745 6.745 0 0 1 12 12a6.745 6.745 0 0 1 6.709 7.498.75.75 0 0 1-.372.568A12.696 12.696 0 0 1 12 21.75c-2.305 0-4.47-.612-6.337-1.684a.75.75 0 0 1-.372-.568 6.787 6.787 0 0 1 1.019-4.38Z"
                    clipRule="evenodd"
                  />
