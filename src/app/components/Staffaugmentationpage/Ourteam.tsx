...
function Ourteam() {
    return (
        <div className='px-4 sm:px-6 md:px-12 lg:px-20 xl:px-28 mb-10'>
            ...
            <div className='flex flex-col gap-y-6'>
                ...
                <div className='flex flex-col gap-y-6'>
                    ...
                    <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-5 xl:grid-cols-5 gap-6'> 
                        ...
                        {/* Card1 */}
                        <div className='flex flex-col gap-4 bg-[#59D7F7] px-4 md:px-6 py-8 md:py-12 rounded-xl'>
                        ...
                        <div className='flex flex-col gap-4 bg-[#59D7F7] px-4 md:px-6 py-8 md:py-12 rounded-xl'>
                            ...
                            <div className='text-center'>
                                <h1 className='text-xl'>UI/UX Designers</h1>
                            </div>
                        </div>
                        ...
                        <div className='flex flex-col gap-4 bg-[#59D7F7] px-4 md:px-6 py-8 md:py-12 rounded-xl'>
                            ...
                            <div className='text-center'>
                                <h1 className='text-xl'>Quality Assurance</h1>
                            </div>
                        </div>
                        ...
                        <div className='flex flex-col gap-4 bg-[#59D7F7] px-4 md:px-6 py-8 md:py-12 rounded-xl'>
                            ...
                            <div className='text-center'>
                                <h1 className='text-xl'>Consultant</h1>
                            </div>
                        </div>
                        ...
                        <div className='flex flex-col gap-4 bg-[#59D7F7] px-4 md:px-6 py-8 md:py-12 rounded-xl'>
                            ...
                            <div className='text-center'>
                                <h1 className='text-xl'>Scrum Masters</h1>
                            </div>
                        </div>
                    </div>
            ...
            <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-6'>
                ...
                <div className='flex flex-col gap-4 bg-[#59D7F7] px-6 py-12 rounded-xl'>
                    {/* SVG */}
                    <div className='flex justify-center'>
                        <svg
                    ...
                    <div className='text-center'>
                        <h1 className='text-xl '>Business Analysts</h1>
                    </div>
                ...
                <div className='flex flex-col gap-4 bg-[#59D7F7] px-6 py-12 rounded-xl'>
                    ...
                    <div className='text-center'>
                        <h1 className='text-xl '>Project Managers</h1>
                    </div>
                ...
                <div className='flex flex-col gap-4 bg-[#59D7F7] px-6 py-12 rounded-xl'>
                    ...
                    <div className='text-center'>
                        <h1 className='text-xl '>Cloud Specialist</h1>
                    </div>
