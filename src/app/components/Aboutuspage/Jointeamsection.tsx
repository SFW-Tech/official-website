      ...
      <div className='grid grid-cols-1 md:grid-cols-2 items-center gap-x-10 gap-y-3 md:gap-x-20 lg:gap-x-32'>
        ...
        <div className='flex flex-col gap-3 text-center md:text-left'>
          ...
          <Link href="/careers" className='cursor-pointer'>
            <button className="flex gap-2 items-center justify-center mx-auto md:mx-0 text-xs sm:text-sm tracking-tight rounded-md text-white bg-cyan-600 px-3 py-1.5 w-fit break-words whitespace-normal hover:bg-cyan-700 transition cursor-pointer">
              View Openings
