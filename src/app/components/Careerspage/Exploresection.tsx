            ...
            <div className='grid grid-cols-1 md:grid-cols-2 gap-x-6 md:gap-x-12 lg:gap-x-20 xl:gap-x-44'>
                ...
                <div className='order-2 md:order-1 flex flex-col justify-center gap-4'>
                    ...
                    <p className='text-sm sm:text-base md:text-md lg:text-lg xl:text-base leading-relaxed'>
                        Softworks offers a wide range of exciting opportunities for young and experienced professionals to be part of our team, to bring ideas, innovativeness and determination to make a difference.
