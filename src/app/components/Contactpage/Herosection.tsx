    ...
    return (
        <div className='w-full'>
            <div
                ...
                "
                style={{
                    backgroundImage: "url('/assets/Contactus/Herosectionassets/banner1.png')",
                }}
            >
                <Navbar />

                <div className="pt-20 md:pt-28 lg:pt-40 xl:pt-[200px] pl-6 md:pl-12 lg:pl-20 xl:pl-[120px]">
