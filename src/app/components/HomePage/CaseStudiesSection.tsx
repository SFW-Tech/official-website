    ...
    return (
        ...
        <div className='w-full mt-20 px-28'>
            ...
            <div className="grid grid-cols-2 mt-25 gap-16">
                ...
                <div className="relative w-[650px] h-[360px] mx-auto flex justify-center gap-6">
                    <img
