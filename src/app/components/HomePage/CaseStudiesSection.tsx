    ...
    return (
        <div className="w-full py-10 px-4 md:px-12 lg:px-20 xl:px-28">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
                ...
                {/* Left Side - Images */}
                <AnimateOnView variants={fadeDown} className="flex flex-col md:flex-row justify-center md:justify-start gap-2">
                    {/* Vision */}
                    <div
                ...
                <AnimateOnView variants={fadeDown} className="flex flex-col gap-6 text-center md:text-left">
                    {content[selected] && (
