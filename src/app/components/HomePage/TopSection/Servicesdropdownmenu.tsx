        ...
        <AnimatePresence>
          {open && (
            <motion.div
              ...
              className="absolute left-1/2 transform -translate-x-1/2 z-10 mt-1 w-40 origin-top rounded-md bg-[#59d7f7] shadow-lg outline-1 outline-black/5 overflow-hidden"
            >
              <MenuItems static>
                <div className="py-1">
                  <MenuItem>
