        ...
        <div className='w-full pr-[120px] relative'>
            ...
            <div className='grid grid-cols-2'>
                ...
                <div className='flex gap-20 relative z-10'>
                    ...
                    <div className='pl-28'>
                        <img src="/assets/aboutusassets/Rectangle.png" className='h-120 w-20' />
                    </div>
                    ...
                    <div className='flex flex-col gap-12 justify-center'>
                        ...
                        <div className='flex gap-4'>
                            <img src="/assets/aboutusassets/about us icon 2.png" className='h-22 w-22' alt="" />
                            <p>We'll help you test bold new ideas while sharing yours.</p>
                        </div>

                        <div className='flex gap-4'>
                            <img src="/assets/aboutusassets/about us icon 3.png" className='h-22 w-22' alt="" />
            ...
            <div className='absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-20'>
                <img
                    src="/assets/aboutusassets/about us image .png"
                    alt="Overlay"
