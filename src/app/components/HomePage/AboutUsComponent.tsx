    ...
    return (
        <div className='w-full pr-4 sm:pr-8 md:pr-16 lg:pr-20 xl:pr-[120px] relative '>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2 gap-2'>
                ...
                >
                    <h1 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-3xl font-bold mb-4">About Us</h1>
                ...
                {/* Right Side */}
                <div className='flex gap-6 md:gap-12 lg:gap-16 xl:gap-20 relative z-10'>
